<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Purchaseitem.aspx.vb" Inherits="Purchaseitem" %>
        ...
        <div class="container">
            <div class="row">
                <div class="header-bar">
                    <div class="col-md-2">
                        <a id="A7" runat="server" href="/Default"><img src="images/logo.png"  class="logo" alt="logobook" ></a>
                    </div>
                    <div class="col-md-6">
                        <div class="tk">
                    ...
                    <div class="col-md-10">
                        <div class="group-tabs">
                            ...
                            <ul class="nav nav-tabs">
                                 <li class="active"><a id="A2" runat="server" href="~/Purchaseitem">Purchase Item</a></li>
                        ...
                        <div class="tab-content">
                            <h3 style="text-align:center; font-weight:bold;">Purchase Item Managerment</h3>
                            <asp:ListView ID="ListView1" runat="server" DataKeyNames="purchase_item_id" DataSourceID="ProductList" InsertItemPosition="LastItem">
                                <AlternatingItemTemplate>
                                    <tr style="">
                                        ...
                                        <td>
                                            <asp:Label ID="purchase_item_idLabel" runat="server" Text='<%# Eval("purchase_item_id") %>' />
                                        </td>
                                        <td>
                                ...
                                <EditItemTemplate>
                                    <tr style="">
                                        ...
                                        <td>
                                            <asp:Label ID="purchase_item_idLabel1" runat="server" Text='<%# Eval("purchase_item_id") %>' />
                                        </td>
                                        <td>
                                ...
                                <InsertItemTemplate>
                                    <tr style="">
                                        ...
                                        <td>
                                            <asp:TextBox ID="purchase_item_idTextBox" runat="server" Text='<%# Bind("purchase_item_id") %>' />
                                        </td>
                                        <td>
                                            <asp:TextBox ID="purchase_idTextBox" runat="server" Text='<%# Bind("purchase_id") %>' />
                                        </td>
                            ...
                            <asp:SqlDataSource ID="ProductList" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [purchaseitem] WHERE [purchase_item_id] = @purchase_item_id" InsertCommand="INSERT INTO [purchaseitem] ([purchase_item_id], [purchase_id], [product_id], [amount]) VALUES (@purchase_item_id, @purchase_id, @product_id, @amount)" SelectCommand="SELECT [purchase_item_id], [purchase_id], [product_id], [amount] FROM [purchaseitem]" UpdateCommand="UPDATE [purchaseitem] SET [purchase_id] = @purchase_id, [product_id] = @product_id, [amount] = @amount WHERE [purchase_item_id] = @purchase_item_id">
                                <DeleteParameters>
                                    <asp:Parameter Name="purchase_item_id" Type="Int32" />
                                </DeleteParameters>
                                <InsertParameters>
                                    <asp:Parameter Name="purchase_item_id" Type="Int32" />
